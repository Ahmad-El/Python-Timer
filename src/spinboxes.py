...
class Spinbox(QSpinBox):
    ...
    def update_all(self, spinbox0, spinbox2):
        self.valueChanged.connect(lambda value: self.update_upper(value, spinbox0))
        self.valueChanged.connect(lambda value: self.update_middle(value))
        self.valueChanged.connect(lambda value: self.update_lower(value, spinbox2))
